export const translations = {
  uk: {
    ...
    home: {
      ...
      tile_signs: "Зовнішня реклама",
      tile_facades: "Вентильовані фасади",
      tile_structures: "Металоконструкції",
    ...
    services: {
      ...
      facades: {
        ...
        desc: "Сучасна якісна естетична тепло- та звукоізоляція фасадів"
      },
      metal: {
        title: "МЕТАЛОКОНСТРУКЦІЇ",
        desc: "Зварні металеві конструкції - міцна основа будь-яких споруд"
      },
      poly: {
        title: "ПОЛІГРАФІЯ",
    ...
    services_page: {
      ...
      categories: [
        {
          title: "Зовнішня реклама",
          items: ["Вивіски", "Світлові літери", "Лайт-бокси", "Світло-динамічні конструкції", "Банери", "Стели", "Вказівники, штендери, таблички", "Реклама на транспорті", "Брендування", "Оформлення вітрин"]
        },
        {
          title: "Вентильовані фасади",
          items: ["Алюмінієві композитні панелі (АКП)", "Керамограніт", "HPL-панелі", "Вхідні групи", "Вентфасад", "Фасадні системи", "Сучасні фасади", "Проектування фасадів", "Утеплення фасадів", "Облицювання фасадів", "Монтаж вентфасаду"]
        },
        {
          title: "Металоконструкції",
          items: ["МАФи", "Дашки", "Навіси", "Сходи", "Перила", "Меблі"]
        },
        {
          title: "Поліграфія",
          items: ["Візитки", "Пластикові картки", "Флаєри", "Брошури", "Меню", "Плакати", "Листівки", "Наліпки, стікери", "Етикетки", "Блокноти", "Папки", "Прапори"]
        }
      ],
  ...
  en: {
    ...
    home: {
      ...
      tile_signs: "Outdoor advertising",
      tile_facades: "Ventilated facades",
      tile_structures: "Metal structures",
      ...
      categories: [
        {
          ...
          items: ["Signs", "Illuminated letters", "Light boxes", "Dynamic light structures", "Banners", "Steles", "Signposts, pavement signs, plaques", "Vehicle advertising", "Branding", "Shop window design"]
        },
        {
          title: "Ventilated facades",
          items: ["Aluminum composite panels (ACP)", "Porcelain stoneware", "HPL panels", "Entrance groups", "Ventilated facade", "Facade systems", "Modern facades", "Facade design", "Facade insulation", "Facade cladding", "Ventilated facade installation"]
        },
        {
          title: "Metal structures",
          items: ["Small architectural forms", "Canopies", "Awnings", "Stairs", "Railings", "Furniture"]
        },
        {
          title: "Printing",
          items: ["Business cards", "Plastic cards", "Flyers", "Brochures", "Menus", "Posters", "Leaflets", "Stickers", "Labels", "Notebooks", "Folders", "Flags"]
        }
      ],
